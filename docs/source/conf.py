...
# -*- coding: utf-8 -*-
#
# Surreal documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'surreal', 'Surreal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Surreal', 'Surreal Documentation',
     author, 'Surreal', 'One line description of project.',
     'Miscellaneous'),
]
